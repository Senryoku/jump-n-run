...
{
	P->ULPos = vec2(0.f, 0.f);
	P->URPos = vec2(50.f, 0.f);
	P->DLPos = vec2(0.f, 210.f);
	P->DRPos = vec2(50.f, 210.f);
...
void plMoveR(Player* P)
{
	...
	{
		//P->Speed.x+=1.5f;
		polyApplyForce(P->Shape, vec2(1.5f, 0.f));
	}
	else
	{
		//P->Speed.x+=0.5f;
		polyApplyForce(P->Shape, vec2(0.5f, 0.f));
	}
}
